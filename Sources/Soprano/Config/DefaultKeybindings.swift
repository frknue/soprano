...
enum DefaultKeybindings {
    static let config = KeyBindingConfig(
        ...
        bindings: [
            ...
            KeyBinding(id: "launch-openclaw", label: "Launch OpenClaw", description: "Launch OpenClaw agent", category: .agents, defaultKeys: "⌘4", mode: .direct, key: "4", meta: true),
            ...
            KeyBinding(id: "new-browser", label: "New Browser", description: "Open a new browser pane", category: .general, defaultKeys: "⌘B", mode: .direct, key: "b", meta: true),
